...
<head>
    ...
    <title>Puy Blog - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default" style="background-color: #9C4C57;">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                    <a href="<?php echo e(url('home')); ?>"> <i class="menu-icon fa fa-home"></i>Beranda</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('category')); ?>"> <i class="menu-icon fas fa-list"></i>Kategori</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('post')); ?>"> <i class="menu-icon fas fa-upload"></i>Post</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('photos')); ?>"> <i class="menu-icon fas fa-image"></i>Photos</a>
                    </li>
                    <li>
                        <a href="<?php echo e(url('album')); ?>"> <i class="menu-icon fas fa-images"></i>Album</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="col-sm-7">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-user"></i> <?php echo e(Auth::user()->name); ?><i class="fas fa-caret-down fa-fw"></i>
                        </a>
                        ...
                        <div class="user-menu dropdown-menu">
                                ...
                                document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt"></i> <?php echo e(__('Logout')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\puyblog\resources\views/main.blade.php ENDPATH**/ ?>