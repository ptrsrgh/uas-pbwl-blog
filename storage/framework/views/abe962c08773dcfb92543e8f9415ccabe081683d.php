                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <td>
                                <a href="<?php echo e(url("/post/{$item->post_id}/edit")); ?>" class="btn btn-warning btn-sm">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\puyblog\resources\views/post/index.blade.php ENDPATH**/ ?>